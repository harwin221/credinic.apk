...
function CheckboxFilterGroup({
  ...
  return (
    <div className="space-y-1 flex flex-col">
      ...
      <div className={cn("rounded-lg border border-gray-200 bg-white p-2 flex flex-col shadow-sm", disabled && "bg-gray-50 cursor-not-allowed")}>
        <ScrollArea className="h-24">
          <div className={cn("space-y-1 pr-3", disabled && "pointer-events-none")}>
            {items.length === 0 ? (
              ...
              items.map((item) => (
                <div key={`${title}-${item.id}`} className="flex items-center gap-2 hover:bg-gray-50 p-1 rounded transition-colors">
                  <Checkbox
                    ...
                    className="h-3.5 w-3.5 border-2 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500 shrink-0"
                  />
        ...
        {items.length > 0 && (
          <div className={cn("border-t border-gray-200 mt-1.5 pt-1.5 flex items-center gap-2", disabled && "pointer-events-none")}>
            <Checkbox
          ...
          <div className="space-y-3 pb-2">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              {selectedSucursales.length > 0 ? (
                ...
                <div className="flex items-center justify-center border-2 border-dashed border-gray-200 rounded-lg bg-gray-50 p-4 text-center">
              ...
              <div className="space-y-1.5">
                ...
                >
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="detailed" id="detailed" className="border-2 h-3.5 w-3.5" />
                    <Label htmlFor="detailed" className="font-normal cursor-pointer text-xs text-gray-700">Detallado</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="summary" id="summary" className="border-2 h-3.5 w-3.5" />

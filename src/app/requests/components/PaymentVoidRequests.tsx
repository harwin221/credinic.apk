...
export function PaymentVoidRequests() {
    const { user } = useUser();
    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                <h2 className="text-xl font-bold">Solicitudes de Anulación de Pagos</h2>
                <Button size="sm" variant="outline" onClick={fetchPendingRequests} disabled={isLoading}>
